...
foreach ($Required in @("lol_minimap_tracker.app", "lol_minimap_tracker.domain.cooldowns", "lol_minimap_tracker.integrations.clickthrough", "lol_minimap_tracker.integrations.cooldown_data", "lol_minimap_tracker.integrations.cooldown_events", "lol_minimap_tracker.ui.calibration", "lol_minimap_tracker.ui.champion_portraits", "lol_minimap_tracker.ui.cooldown_panel", "QtSvg.pyd", "cv2.pyd", "mss.windows", "windows_capture\\windows_capture.pyd", "position-top.svg")) {
