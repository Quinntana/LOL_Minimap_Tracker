...
foreach ($Required in @("lol_minimap_tracker.app", "lol_minimap_tracker.integrations.clickthrough", "lol_minimap_tracker.ui.calibration", "lol_minimap_tracker.ui.champion_portraits", "QtSvg.pyd", "cv2.pyd", "mss.windows", "windows_capture\\windows_capture.pyd", "position-top.svg")) {
